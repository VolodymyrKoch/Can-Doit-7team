...
const Accordion = props => {
  ...
  <>
    <div className={style.container}>
			<details>
					<summary><span className={style.iconItem1}></span>Надзвичайні ситуації<svg xmlns="http://www.w3.org/2000/svg" className={style.icon} viewBox="0 0 20 20" fill="white">
					<path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
				</svg>
				</summary>
				<div className={style.information}>
					<details>
						<summary>Небезпеки під час війни<svg xmlns="http://www.w3.org/2000/svg" className={style.icon} viewBox="0 0 20 20" fill="white">
							<path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
						</svg>
						</summary>
						<div className={style.information}>
			...
			<details>
				<summary><span className={style.iconItem2}></span>Домедична допомога<svg xmlns="http://www.w3.org/2000/svg" className={style.icon} viewBox="0 0 20 20" fill="white">
					<path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
				</svg>
				</summary>
				<div className={style.information}>
